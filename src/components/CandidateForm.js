const CandidateForm = () => {
  return (
    <div className="absolute top-[1531px] left-[461px] w-[350px] h-40 text-left text-inherit text-gray-200 font-inherit">
      <b className="absolute top-[0px] left-[68px]">
      ...
      <div className="absolute top-[66px] left-[4px] text-3xs font-inter">
        <p className="[margin-block-start:0] [margin-block-end:5px]">
          Yrs of Exp:
        </p>
