const Header4 = () => {
  return (
    <div className="absolute top-[0px] left-[0px] w-[1280px] h-[62px] text-left text-xs text-gray-500 font-inter">
      ...
      />
      <div className="absolute top-[0px] left-[961px] bg-whitesmoke w-20 h-[62px]" />
      <b className="absolute top-[42px] left-[1062px]">Profile</b>
      <b className="absolute top-[41px] left-[987px] text-darkslategray-100 opacity-[0.8]">
        Help
      </b>
      ...
      />
      <b className="absolute top-[41px] left-[828px]">Jobs</b>
      <img
        className="absolute top-[11px] left-[828px] w-[30.83px] h-[25px] object-cover opacity-[0.8]"
        alt=""
        src="/briefcasefill-1@2x.png"
      />
    </div>
  );
};
